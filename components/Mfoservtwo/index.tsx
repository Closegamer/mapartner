...
const Mfoservtwo = () => {
    ...
    return (
        <section id="mfoservtwo" className="relative z-10 py-4">
            <div className="container">
                <div className="grid grid-cols-1 gap-x-8 gap-y-10 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <PricingBoxServ
                        ...
                        duration={""}
                        subtitle="Подбор вариантов"
                        link={"https://refk.in/001gn"}
                    >
                        <OfferList text="Возраст: от 18 лет" status="active" />
                        <OfferList text="Срок: 3 - 30 дней" status="active" />
                        <OfferList text="Банковская карта" status="active" />
                        <OfferList text="Гражданство РФ" status="active" />
                    </PricingBoxServ>
                </div>

...
const Mfofive = () => {
    ...
    return (
        <section id="mfofive" className="relative z-10 py-4">
            <div className="container">
                <div className="grid grid-cols-1 gap-x-8 gap-y-10 md:grid-cols-2 lg:grid-cols-3">
                    <PricingBox
                        ...
                        link="https://refk.in/001bq"
                    >
                        <OfferList text="Быстрое рассмотрение" status="active" />
                        <OfferList text="97% одобрений" status="active" />
                    ...
                    <PricingBox
                        ...
                        price={" 100 000"}
                        duration={""}
                        subtitle="Срок: от 7 до 365 дней"
                        link={"https://refk.in/001bt"}
                    >
                        <OfferList text="Быстрое рассмотрение" status="active" />
                        <OfferList text="Плохая КИ" status="active" />
                        <OfferList text="Гражданство РФ" status="active" />
                        <OfferList text="Возраст: 18 - 88 лет" status="active" />
                        <OfferList text="Банковская карта" status="active" />
                    </PricingBox>
                    <PricingBox
                        ...
                        link={"https://refk.in/001bu"}
                    >
                        <OfferList text="Быстрый скоринг" status="active" />
                        <OfferList text="Плохая КИ" status="active" />
                        <OfferList text="Гражданство РФ" status="active" />

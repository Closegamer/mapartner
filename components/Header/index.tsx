...
const Header = ({session, admin}) => {
  ...
  const signOutHandler = async () => {
    await axios.post('/auth/signout', {url: 'about'})
  }
  ...
  const LogoBlack = React.forwardRef((props, ref) => {
    return (<Image
    ...
    />)
    LogoBlack.displayName = "LogoBlack";
  })

  // eslint-disable-next-line react/display-name
  const LogoWhite = React.forwardRef((props, ref) => {
    return (<Image
